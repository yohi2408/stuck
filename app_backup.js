...
function displayStockData(data) {
    ...
    document.getElementById('currentPrice').textContent = `$${data.recommendation.current_price.toFixed(2)}`;
    ...
    // Recommendations
    document.getElementById('shortTermRec').textContent = data.recommendation.short_term;
    document.getElementById('shortTermRec').className = `rec-badge ${getBadgeClass(data.recommendation.short_term)}`;
    document.getElementById('shortTermConf').textContent = `ביטחון: ${data.recommendation.short_term_confidence}`;

    document.getElementById('longTermRec').textContent = data.recommendation.long_term;
    document.getElementById('longTermRec').className = `rec-badge ${getBadgeClass(data.recommendation.long_term)}`;
    ...
    // Explanation
    document.getElementById('explanation').textContent = data.recommendation.explanation;
...
function getBadgeClass(recommendation) {
    if (recommendation.includes('Strong Buy') || recommendation.includes('Buy')) return 'badge-success';
